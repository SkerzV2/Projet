...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 05 avr. 2024 à 23:36
...
(39, 6, 1, '#crise1929#régimestotalitaires', 1);
...
(2, '2024-01-25', '2024-09-04', '#nombresrelatifs#intégrale#loidepoisson#probabilités#statistiques', 5, 4, 1),
...
(7, '2024-03-22', '2023-10-27', '#verbesirréguliers#gérondif#présent#date', 1, 1, 0),
...
(13, '2024-11-19', '2024-11-22', '#dhcp#dns#voip', 5, 5, 1),
...
(19, '2024-04-05', '2024-04-19', '#gérondif#présent#date', 2, 1, 1);
...
(1, 1, 15, 101, '2023-12-17', '2023-12-16', 'adad', 2),
(2, 12, 21, 101, '2023-12-17', '2023-12-16', 'adadadaz', 2),
(3, 2, 15, 101, '2023-12-17', '2023-12-16', 'adadadaz', 2),
(4, 14, 21, 101, '2023-12-17', '2023-12-16', 'azdsxad', 1),
(5, 12, 21, 101, '2023-12-17', '2023-12-16', 'adsxcc', 1),
(6, 2, 15, 101, '2024-03-23', '2024-03-22', 'Je suis dispo quand vous voulez', 1),
(7, 13, 26, 101, '2024-11-20', '2024-04-05', 'zadadazd', 1);
...
(1, 'Castaing', 'Sabine', 'sabine.castaing@lerebours.org', 'sabcas', 'Admin', '5', 2, '0661010101'),
...
(9, 'Ioualitene', 'Fatah', 'loualitene.fatah@lerebours.org', 'fatlou', 'Etudiant', '2', 1, '0661090909');
